...
namespace TinyBin
{
    public partial class SettingsWindow : Form
    {
        ...
        public SettingsWindow()
        {
            ...
            label1.Font = new Font(FontsManager.pfc.Families[0], 9);
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            //Write settings
            BinaryDataWriter.WriteToFile(Convert.ToInt32(textBox1.Text), checkBox1.Checked, checkBox2.Checked);
        ...
        async void BackgroundWork()
        {
            while (true)
            {
                ...
                if (Bin.GetCount() == 0)
                {
                    if (uxtheme.ShouldSystemUseDarkMode()) notifyIcon1.Icon = Properties.Resources.emptyWHITE;
                    else if (!uxtheme.ShouldSystemUseDarkMode()) notifyIcon1.Icon = Properties.Resources.emptyDARK;
                    currentBinType = "Empty";
                }
                else
                {
                    if (uxtheme.ShouldSystemUseDarkMode()) notifyIcon1.Icon = Properties.Resources.filledWHITE;
                    else if (!uxtheme.ShouldSystemUseDarkMode()) notifyIcon1.Icon = Properties.Resources.filledDARK;

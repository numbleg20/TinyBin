    ...
    public partial class SettingsWindow : Form
    {
        ...
        public SettingsWindow()
        {
            ...
            notifyIcon1.DoubleClick += (sender, e) => {
                if (radioButton1.Checked) Bin.Empty();
                else if (radioButton2.Checked) Bin.OpenFolder();
                else if (radioButton3.Checked) Show(); TopMost = true;
            };
            ...
            radioButton1.Checked = BinaryDataReader.DBLCLICKemptyBin;
            radioButton2.Checked = BinaryDataReader.DBLCLICKopenFolder;
            radioButton3.Checked = BinaryDataReader.DBLCLICKopenSettings;
        }
